...
namespace PMVOnline.Users
{
     ...
     */
      class AppUser : FullAuditedAggregateRoot<Guid>//, IUser
    {
         ...
         *
         * 1. Update PMVOnlineDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PMVOnlineEfCoreEntityExtensionMappings to extend the IdentityUser entity
        ...
        {
            if (Roles.Any(d => d.RoleId == role.RoleId && d.UserId == role.UserId))
            {
                return;
            }
            Roles.Add(role);
