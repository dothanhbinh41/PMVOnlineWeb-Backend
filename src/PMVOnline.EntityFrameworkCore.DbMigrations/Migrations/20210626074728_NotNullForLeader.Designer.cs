...
{
    [DbContext(typeof(PMVOnlineMigrationsDbContext))]
    [Migration("20210626074728_NotNullForLeader")]
    partial class NotNullForLeader
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMVOnline.Departments.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PMVOnline.Departments.DepartmentUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PMVOnline.Guides.Guide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PMVOnline.Targets.DepartmentTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppDepartmentTargets");
                });

            modelBuilder.Entity("PMVOnline.Targets.Target", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTargets");
                });

            modelBuilder.Entity("PMVOnline.Tasks.ReferenceTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PMVOnline.Tasks.TaskCommentFile", b =>
                {
                    ...
                    b.ToTable("AppTaskCommentFiles");
                });

            modelBuilder.Entity("PMVOnline.Tasks.TaskFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppTaskFiles");
                });

            modelBuilder.Entity("PMVOnline.Tasks.TaskFollow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PMVOnline.Tasks.TaskRating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PMVOnline.Users.UserDeviceToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PMVOnline.Departments.DepartmentUser", b =>
                {
                    b.HasOne("PMVOnline.Departments.Department", "Department")
            ...
            modelBuilder.Entity("PMVOnline.Targets.DepartmentTarget", b =>
                {
                    ...
                    b.HasOne("PMVOnline.Targets.Target", "Target")
                        .WithMany("DepartmentTargets")
            ...
            modelBuilder.Entity("PMVOnline.Tasks.Task", b =>
                {
                    ...
                    b.HasOne("PMVOnline.Users.AppUser", "Leader")
                        .WithMany()
            ...
            modelBuilder.Entity("PMVOnline.Tasks.TaskCommentFile", b =>
                {
                    b.HasOne("PMVOnline.Tasks.TaskComment", "Comment")
                        .WithMany("FileIds")
            ...
            modelBuilder.Entity("PMVOnline.Tasks.TaskFile", b =>
                {
                    b.HasOne("PMVOnline.Files.File", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("PMVOnline.Targets.Target", b =>
                {
                    b.Navigation("DepartmentTargets");
                });
